...

{
  ...
  xsession = {
    ...
    windowManager.i3.extraConfig = ''
      ...
      exec --no-startup-id i3-msg "workspace ${workspace3}; append_layout ${config.resources.paths.publicDotfiles}/i3/layouts/emacs.json" &&  while ! $DOOM/bin/emacsclient --socket-name=/tmp/emacs1000/server -ca false; do sleep 2; done;
